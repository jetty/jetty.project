...
rm -fr contexts etc lib logs start.jar webapps start.ini
...
ln -s $HOME/.m2/repository/org/mortbay/jetty/servlet-api/3.0-SNAPSHOT/servlet-api-3.0-SNAPSHOT.jar servlet-api-3.0.jar
cd ..
