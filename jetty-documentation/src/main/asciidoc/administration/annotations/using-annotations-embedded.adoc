...
You can obtain them from the https://download.eclipse.org/jetty/stable-9/dist/[Jetty distribution], or the https://repo1.maven.org/maven2/org/eclipse/jetty/jetty-annotations[Maven repository]:
