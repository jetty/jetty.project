...
You can obtain them from the https://www.eclipse.org/jetty/download.html[Jetty distribution], or the https://repo.maven.apache.org/maven2/org/eclipse/jetty/jetty-annotations[Maven repository]:
