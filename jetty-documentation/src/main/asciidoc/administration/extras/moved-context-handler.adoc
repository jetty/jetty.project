...
You can configure it to _permanently_ redirect the old URL to the new URL, in which case Jetty sends an Http Status code of 301 to the browser with the new URL.
