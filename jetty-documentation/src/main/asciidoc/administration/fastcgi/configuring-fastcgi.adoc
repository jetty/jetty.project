...
At this point, you can start Jetty (see xref:startup[]), hit `http://localhost:8080` with your browser and enjoy WordPress via HTTP/2 using an HTTP/2 enabled browser:
...
If you don't have an HTTP/2 enabled browser, WordPress will still be available over HTTP/1.1.
