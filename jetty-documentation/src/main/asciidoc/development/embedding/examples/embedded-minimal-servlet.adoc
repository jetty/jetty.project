...
It is really simple to create useful servlets for testing behaviors. Sometimes you need an http server to run a unit test against that will return test content and wiring up a servlet like this makes it trivial.
