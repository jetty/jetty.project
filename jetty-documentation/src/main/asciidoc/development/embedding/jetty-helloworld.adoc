...
You can manually download the aggregate link:https://repo.maven.apache.org/maven2/org/eclipse/jetty/aggregate/jetty-all/{VERSION}/jetty-all-{VERSION}-uber.jar[`jetty-all.jar`] using `curl` or a browser.
...
> mkdir Demo
> cd Demo
> curl -o jetty-all-uber.jar https://repo.maven.apache.org/maven2/org/eclipse/jetty/aggregate/jetty-all/{VERSION}/jetty-all-{VERSION}-uber.jar
....
