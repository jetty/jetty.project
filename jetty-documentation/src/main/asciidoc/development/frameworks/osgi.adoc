...
|https://repo.maven.apache.org/maven2/org/apache/aries/spifly/org.apache.aries.spifly.dynamic.bundle/[Maven central]
|org.apache.aries:org.apache.aries.util-1.0.1.jar |org.apache.aries.util
|https://repo.maven.apache.org/maven2/org/apache/aries/org.apache.aries.util/[Maven
central]
|=======================================================================
...
Now that you have the basic set of Jetty jars installed, you can install the https://repo.maven.apache.org/maven2/org/eclipse/jetty/osgi/jetty-osgi-boot/[jetty-osgi-boot.jar] bundle, downloadable from the maven central repo https://repo.maven.apache.org/maven2/org/eclipse/jetty/osgi/jetty-osgi-boot/[here.]
...
Some you will find in the Jetty distribution, whereas others you will need to download from https://repo.maven.apache.org/maven2/org/eclipse/jetty/orbit/[Maven central].
...
|https://repo.maven.apache.org/maven2/org/eclipse/jetty/osgi/jetty-osgi-boot-jsp[Maven central]
|=======================================================================
...
To be able to use JSPs you will need to also install the https://repo.maven.apache.org/maven2/org/eclipse/jetty/osgi/jetty-osgi-boot-jsp/[jetty-osgi-boot-jsp.jar] into your OSGi container.
This jar can be obtained from maven central https://repo.maven.apache.org/maven2/org/eclipse/jetty/osgi/jetty-osgi-boot-jsp/[here].
...
|https://repo.maven.apache.org/maven2/org/ow2/asm/asm[Maven central]

|org.ow2.asm:asm-commons-5.0.1.jar |org.objectweb.asm.commons
|https://repo.maven.apache.org/maven2/org/ow2/asm/asm-commons[Maven central]

|org.ow2.asm:asm-tree-5.0.1.jar |org.objectweb.asm.tree
|https://repo.maven.apache.org/maven2/org/ow2/asm/asm-tree[Maven central]

|javax.annotation:javax.annotation-api-1.2.jar |javax.annotation-api
|https://repo.maven.apache.org/maven2/javax/annotation/javax.annotation-api/[Maven
central]
...
|https://repo.maven.apache.org/maven2/javax/websocket/websocket-api[Maven
central]
|=======================================================================
