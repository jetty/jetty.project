...
Once you have a copy of the Jetty distribution link:#qsgd-jetty-downloading[downloaded,] extract the `zip` or `tar.gz` file to a location where you have read and write access.
