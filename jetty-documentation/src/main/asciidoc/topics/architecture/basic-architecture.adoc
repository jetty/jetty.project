...
image:architecture/images/jetty-high-level-architecture.png[image,width=576]
...
image:architecture/images/basic-architecture-patterns.png[image,width=576]
...
image:architecture/images/basic-architecture-handlers.png[image,width=576]
...
image:architecture/images/basic-architecture-nested-handlers.png[image,width=576]
...
image:architecture/images/basic-architecture-servlet-handler.png[image,width=576]
...
image:architecture/images/basic-architecture-web-application.png[image,width=576]
