...
-->
  ...
  <xsl:template name="user.head.content">
    ...
    <xsl:element name="link">
      ...
      <xsl:attribute name="href">../common/css/highlighter/foundation.css</xsl:attribute>
    </xsl:element>
    <xsl:element name="script">
      <xsl:attribute name="src">../common/js/highlight.pack.js</xsl:attribute>
    </xsl:element>
    <xsl:element name="script">
    ...
    <xsl:element name="link">
      ...
      <xsl:attribute name="rel">stylesheet</xsl:attribute>
      <xsl:attribute name="href">../common/css/font-awesome/font-awesome.min.css</xsl:attribute>
    </xsl:element>
  ...
  <xsl:template name="user.header.navigation">
    <table>
      <tr>
        <td style="width: 25%">
          <a href="http://www.eclipse.org/jetty"><img src="../common/images/jetty-header-logo.png" alt="Jetty Logo"></img></a>
          <br/>
