...
CDI integration modes can be selected per webapp with the "org.eclipse.jetty.ee10.cdi"
init parameter or defaults to the mode set by the "org.eclipse.jetty.ee10.cdi" server
