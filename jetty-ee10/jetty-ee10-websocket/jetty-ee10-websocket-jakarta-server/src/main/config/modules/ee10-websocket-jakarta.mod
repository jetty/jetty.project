...
lib/ee10-websocket/jakarta.websocket-client-api-@ee10.jakarta.websocket.api.version@.jar
lib/ee10-websocket/jakarta.websocket-api-@ee10.jakarta.websocket.api.version@.jar
