...
lib/ee11-websocket/jakarta.websocket-client-api-@ee11.jakarta.websocket.api.version@.jar
lib/ee11-websocket/jakarta.websocket-api-@ee11.jakarta.websocket.api.version@.jar
