...
[files]
logs/
basehome:modules/ee8-debug.d/ee8-debug.properties|webapps/ee8-debug.properties
basehome:modules/ee8-debug.d/jetty-ee8-debug.xml|etc/jetty-ee8-debug.xml
