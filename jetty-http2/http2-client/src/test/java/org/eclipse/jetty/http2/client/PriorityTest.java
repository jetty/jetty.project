...
public class PriorityTest extends AbstractTest
{
    ...
    public void testPriorityBeforeHeaders() throws Exception
    {
        ...
        MetaData metaData = newRequest("GET", HttpFields.build());
    ...
    public void testPriorityAfterHeaders() throws Exception
    {
        ...
        Session session = newClient(new Session.Listener.Adapter());
        MetaData metaData1 = newRequest("GET", "/one", HttpFields.build());
        ...
        MetaData metaData2 = newRequest("GET", "/two", HttpFields.build());
    ...
    public void testHeadersWithPriority() throws Exception
    {
        ...
        Session session = newClient(new Session.Listener.Adapter());
        MetaData metaData = newRequest("GET", "/one", HttpFields.build());
