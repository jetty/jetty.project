...
public class RewriteHandlerTest extends AbstractRuleTestCase
{
    ...
    public void test() throws Exception
    {
        ...
        _request.setContextPaths(_request.getContextPath(), "/xxx/bar");
        ...
        _request.setContextPaths(_request.getContextPath(), "/foo/bar");
        ...
        _request.setContextPaths(_request.getContextPath(), "/aaa/bar");
    ...
    public void testEncodedPattern() throws Exception
    {
        ...
        _request.setContextPaths(_request.getContextPath(), "/ccc/x y");
    ...
    public void testEncodedRegex() throws Exception
    {
        ...
        _request.setContextPaths(_request.getContextPath(), "/xxx/x y");
