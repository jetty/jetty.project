...
public class RewriteHandlerTest extends AbstractRuleTestCase
{
    ...
    public void test() throws Exception
    {
        ...
        _request.setHttpURI(HttpURI.from(_request.getHttpURI(), "/xxx/bar").toHttpURI());
        ...
        _request.setHttpURI(HttpURI.from(_request.getHttpURI(), "/foo/bar").toHttpURI());
        ...
        _request.setHttpURI(HttpURI.from(_request.getHttpURI(), "/aaa/bar").toHttpURI());
    ...
    public void testEncodedPattern() throws Exception
    {
        ...
        _handler.setRewriteRequestURI(true);
        _handler.setRewritePathInfo(false);
        _request.setHttpURI(HttpURI.from(_request.getHttpURI(), "/ccc/x%20y").toHttpURI());
    ...
    public void testEncodedRegex() throws Exception
    {
        ...
        _handler.setRewriteRequestURI(true);
        _handler.setRewritePathInfo(false);
        _request.setHttpURI(HttpURI.from(_request.getHttpURI(), "/xxx/x%20y").toHttpURI());
