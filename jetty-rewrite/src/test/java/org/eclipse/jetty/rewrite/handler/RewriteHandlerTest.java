...
public class RewriteHandlerTest extends AbstractRuleTestCase
{
    ...
    public void test() throws Exception
    {
        ...
        assertTrue(_handler.handle("/xxx/bar", _request, _request, _response));
        ...
        assertTrue(_handler.handle("/foo/bar", _request, _request, _response));
        assertEquals(201, _response.getStatus());
        ...
        assertTrue(_handler.handle("/aaa/bar", _request, _request, _response));
        assertEquals(201, _response.getStatus());
    ...
    public void testEncodedPattern() throws Exception
    {
        ...
        assertTrue(_handler.handle("/ccc/x y", _request, _request, _response));
        assertEquals(201, _response.getStatus());
    ...
    public void testEncodedRegex() throws Exception
    {
        ...
        assertTrue(_handler.handle("/xxx/x y", _request, _request, _response));
        assertEquals(201, _response.getStatus());
