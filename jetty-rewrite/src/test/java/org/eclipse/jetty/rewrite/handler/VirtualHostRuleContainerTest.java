...
public class VirtualHostRuleContainerTest extends AbstractRuleTestCase
{
    ...
    public void init() throws Exception
    {
        ...
        start(false);
        _request.setHttpURI(HttpURI.from(_request.getHttpURI(), "/cheese/bar").toHttpURI());
    ...
    {
        _request.setHttpURI(HttpURI.from(_request.getRequestURI()).authority("cheese.com", 0).toHttpURI());
    ...
    {
        _request.setHttpURI(HttpURI.from(_request.getRequestURI()).authority("foo.com", 0).toHttpURI());
    ...
    private void checkWildcardHost(boolean succeed, String[] ruleHosts, String[] requestHosts) throws Exception
    {
        ...
        {
            _request.setHttpURI(HttpURI.from(_request.getRequestURI()).authority(host, 0).toHttpURI());
            _request.setHttpURI(HttpURI.from(_request.getHttpURI(), "/cheese/bar").toHttpURI());
            handleRequest();
            if (succeed)
