...
public class VirtualHostRuleContainerTest extends AbstractRuleTestCase
{
    ...
    public void init() throws Exception
    {
        ...
        start(false);
        _request.setHttpURI(HttpURI.build(_request.getHttpURI(), "/cheese/bar").asImmutable());
    ...
    {
        _request.setHttpURI(HttpURI.build(_request.getRequestURI()).authority("cheese.com", 0).asImmutable());
    ...
    {
        _request.setHttpURI(HttpURI.build(_request.getRequestURI()).authority("foo.com", 0).asImmutable());
    ...
    private void checkWildcardHost(boolean succeed, String[] ruleHosts, String[] requestHosts) throws Exception
    {
        ...
        {
            _request.setHttpURI(HttpURI.build(_request.getRequestURI()).authority(host, 0).asImmutable());
            _request.setHttpURI(HttpURI.build(_request.getHttpURI(), "/cheese/bar").asImmutable());
            handleRequest();
            if (succeed)
