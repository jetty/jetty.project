 ...
 *
 */
public abstract class HttpServerConnection  extends AbstractConnection
{
    private static final Logger LOG = Log.getLogger(HttpServerConnection.class);

    private static final int UNKNOWN = -2;
    private static final ThreadLocal<HttpServerConnection> __currentConnection = new ThreadLocal<HttpServerConnection>();
    ...
    /* ------------------------------------------------------------ */
    public static HttpServerConnection getCurrentConnection()
    {
        return __currentConnection.get();
    }

    /* ------------------------------------------------------------ */
    protected static void setCurrentConnection(HttpServerConnection connection)
    {
     ...
     *
     */
    public HttpServerConnection(Connector connector, EndPoint endpoint, Server server)
    {
        super(endpoint);
    ...
    public ServletInputStream getInputStream() throws IOException
    {
        ...
        if (_in == null)
            _in = new HttpInput(HttpServerConnection.this);
        return _in;
    }
    ...
    public class Output extends HttpOutput
    {
        Output()
        {
            super(HttpServerConnection.this);
        }
    ...
    public class OutputWriter extends HttpWriter
    {
        OutputWriter()
        {
            super(HttpServerConnection.this._out);
        }
    }
