 ...
 */
public abstract class AbstractSynInfo
{
    /**
    ...
    /**
     * <p>Creates a new {@link AbstractSynInfo} instance with empty headers and the given close flag,
     * not unidirectional, without associated stream, and with default priority.</p>
     *
     * @param close the value of the close flag
     */
    public AbstractSynInfo(boolean close)
    {
     ...
     * @param close the value of the close flag
     */
    public AbstractSynInfo(Headers headers, boolean close)
    {
     ...
     *            the priority
     */
    public AbstractSynInfo(Headers headers, boolean close, byte priority)
    {
        this.close = close;
    ...
    /**
     * @return true if this synInfo is for a unidirectional stream, false otherwise
     */
    public abstract boolean isUnidirectional();
    
    /**
     * @return associated stream id or 0 if this is 
     */
    public abstract int getAssociatedStreamId();
