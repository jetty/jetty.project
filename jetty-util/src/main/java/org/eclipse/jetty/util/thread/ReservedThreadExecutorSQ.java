...
public class ReservedThreadExecutorSQ extends AbstractLifeCycle implements TryExecutor
{
     ...
     * thread pool size.
     */
    public ReservedThreadExecutorSQ(Executor executor, int capacity)
    {
        _executor = executor;
    ...
    private class ReservedThread implements Runnable
    {
        ...
        public String toString()
        {
            return String.format("%s@%x", ReservedThreadExecutorSQ.this, hashCode());
        }
    }
}
