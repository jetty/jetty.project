...
public class ReservedThreadExecutorSQ2 extends AbstractLifeCycle implements TryExecutor
{
     ...
     * thread pool size.
     */
    public ReservedThreadExecutorSQ2(Executor executor, int capacity)
    {
        _executor = executor;
    ...
    private class ReservedThread implements Runnable
    {
        ...
        public String toString()
        {
            return String.format("%s@%x", ReservedThreadExecutorSQ2.this, hashCode());
        }
    }
}
