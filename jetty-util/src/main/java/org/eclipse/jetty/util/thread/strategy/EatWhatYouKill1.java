...
public class EatWhatYouKill1 extends ContainerLifeCycle implements ExecutionStrategy, Runnable
{
    ...
    public EatWhatYouKill1(Producer producer, Executor executor)
    {
        _producer = producer;
        _executor = executor;
