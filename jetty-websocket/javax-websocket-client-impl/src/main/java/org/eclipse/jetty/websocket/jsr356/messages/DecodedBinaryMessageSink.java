...
{
    public DecodedBinaryMessageSink(WebSocketPolicy policy, WSLocalEndpoint<JsrSession> endpointFunctions, Decoder.Binary decoder, Function<Object, Object> onMessageFunction)
    {
