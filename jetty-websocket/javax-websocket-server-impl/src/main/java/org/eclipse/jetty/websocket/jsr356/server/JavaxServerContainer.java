...
public class JavaxServerContainer extends JavaxClientContainer implements javax.websocket.server.ServerContainer
{
    private static final Logger LOG = Log.getLogger(JavaxServerContainer.class);
     ...
     */
    public JavaxServerContainer(WebSocketContainerContext containerContext, MappedWebSocketServletNegotiator mappedWebSocketServletNegotiator, HttpClient httpClient)
    {
