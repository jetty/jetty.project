...
public class WebSocketUpgradeRequest extends HttpRequest implements CompleteListener, HttpConnectionUpgrader
{
    ...
    private Object asClientUpgradeRequest;
     ...
     * @param localEndpointImpl the WebSocket {@code LocalEndpointImpl} to use for this upgrade
     */
    public WebSocketUpgradeRequest(WebSocketClientImpl wsClient, ClientUpgradeRequest upgradeRequest, LocalEndpointImpl localEndpointImpl)
    {
        super(wsClient.getHttpClient(), new HttpConversation(), upgradeRequest.getRequestURI());

        this.clientUpgradeRequest = upgradeRequest;

        apiRequestFacade = new ClientUpgradeRequestFacade();
        apiRequestFacade.init(clientUpgradeRequest);
    ...
    public void upgrade(HttpResponse response, HttpConnectionOverHTTP oldConn)
    {
        ...
        extensionStack.negotiate(objectFactory, wsClient.getPolicy(), wsClient.getBufferPool(), extensions);
        ...
        WSSession session = wsClient.createSession(requestURI, connection);
