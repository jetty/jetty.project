...
public class LocalServer extends ContainerLifeCycle implements TestWebSocketServer.Provider
{
    ...
    public TestWebSocket newClient() throws Exception
    {
        return new TestWebSocketClient(this);
    }

    public TestWebSocket newClient(CharSequence requestPath) throws Exception
    {
        return new TestWebSocketClient(this, requestPath);
    }

    public TestWebSocket newClient(CharSequence requestPath, Map<String, String> upgradeRequest) throws Exception
    {
        return new TestWebSocketClient(this, requestPath, upgradeRequest);
    }
    ...
    {
        registerWebSocket(urlPattern, (factory -> factory.setCreator(creator)));
    }

    public void registerWebSocket(String urlPattern, Consumer<WebSocketServletFactory> configureFactoryConsumer)
    {
        ServletHolder holder = new ServletHolder(new WebSocketServlet()
        {
            ...
            {
                configureFactoryConsumer.accept(factory);
            }
        });
        servletContextHandler.addServlet(holder, urlPattern);
    }
