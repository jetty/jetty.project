...
public class TestWebSocketServer extends TestWebSocket.Adapter implements TestWebSocket, AutoCloseable
{
    ...
    public TestWebSocketServer(Provider provider) throws Exception
    {
        this(provider, null);
    }

    public TestWebSocketServer(Provider provider, CharSequence requestPath) throws Exception
    {
        this(provider, requestPath, UpgradeUtils.newDefaultUpgradeRequestHeaders());
    }

    public TestWebSocketServer(Provider provider, CharSequence requestPath, Map<String, String> headers) throws Exception
    {
        super();
