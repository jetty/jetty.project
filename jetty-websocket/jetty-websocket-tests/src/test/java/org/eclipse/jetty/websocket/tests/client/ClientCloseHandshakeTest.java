...
public class ClientCloseHandshakeTest
{
    ...
    public void testClientInitiated_NoData() throws Exception
    {
        ...
        try (StacklessLogging ignored = new StacklessLogging(clientSocket.LOG))
        {
            ...
            clientSocket.assertCloseStatus("Client", StatusCode.NORMAL, containsString("Normal"));
        }
        finally
        {
            clientSession.close();
    ...
    public void testClientInitiated_NoData_ChangeClose() throws Exception
    {
        ...
        try (StacklessLogging ignored = new StacklessLogging(clientSocket.LOG))
        {
            ...
            // verify client close
            clientSocket.awaitCloseEvent("Client");
            clientSocket.assertCloseStatus("Client", StatusCode.SHUTDOWN, containsString("Server Shutdown"));
        }
        finally
        {
            clientSession.close();
    ...
    public void testServerInitiated_NoData() throws Exception
    {
        ...
        try (StacklessLogging ignored = new StacklessLogging(clientSocket.LOG))
        {
            ...
            // verify client close
            clientSocket.awaitCloseEvent("Client");
            clientSocket.assertCloseStatus("Client", StatusCode.NORMAL, containsString("Server initiated"));
        }
        finally
        {
            clientSession.close();
