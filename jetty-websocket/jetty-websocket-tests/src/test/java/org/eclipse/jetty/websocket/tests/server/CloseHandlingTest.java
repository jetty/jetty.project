...
public class CloseHandlingTest extends AbstractLocalServerCase
{
    ...
    public void testClose_MaxReasonLength() throws Exception
    {
        ...
        List<Frame> send = new ArrayList<>();
        send.add(CloseStatus.toFrame(StatusCode.NORMAL,reason));

        List<Frame> expect = new ArrayList<>();
        expect.add(CloseStatus.toFrame(StatusCode.NORMAL,reason));
    ...
    {
        List<Frame> send = new ArrayList<>();
        send.add(CloseStatus.toFrame(StatusCode.NORMAL,"Hic"));

        List<Frame> expect = new ArrayList<>();
        expect.add(CloseStatus.toFrame(StatusCode.NORMAL,"Hic"));
