...
public class WebSocketClientInitTest
{
    ...
    public void testInit_HttpClient_StartedOutside() throws Exception
    {
        ...
        try
        {
            ...
            try
            {
                ...
                assertThat("WebSocketClient bean found in HttpClient",http.getBean(WebSocketClient.class),is(ws));
            }
            finally
            {
                ws.stop();
    ...
    public void testInit_HttpClient_SyntheticStart() throws Exception
    {
        ...
        try
        {
            ...
            assertThat("WebSocketClient bean found in HttpClient",http.getBean(WebSocketClient.class),sameInstance(ws));
        }
        finally
        {
            ws.stop();
