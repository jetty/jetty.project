...
public class WebSocketRemoteEndpoint implements RemoteEndpoint
{
    ...
    @Override
    public void sendBytes(ByteBuffer data, Callback callback)
    {
        assertIsOpen();
        lockMsg(MsgType.ASYNC);
        try
        {
            ...
            uncheckedSendFrame(new BinaryFrame().setPayload(data), callback == null ? Callback.NOOP : callback);
        }
        finally
        {
            unlockMsg(MsgType.ASYNC);
    ...
    public void uncheckedSendFrame(WebSocketFrame frame, Callback callback)
    {
        assertIsOpen();
        try
        {
    ...
    @Override
    public void sendString(String text, Callback callback)
    {
        assertIsOpen();
        lockMsg(MsgType.ASYNC);
        try
        {
            ...
            uncheckedSendFrame(frame, callback == null ? Callback.NOOP : callback);
        }
        finally
        {
            unlockMsg(MsgType.ASYNC);
