...
import org.eclipse.jetty.websocket.core.scopes.WebSocketSessionScope;
import org.eclipse.jetty.websocket.core.util.CompletionCallback;

@ManagedObject("A Jetty WebSocket Session")
public class WebSocketSession extends ContainerLifeCycle implements Session,
        WebSocketSessionScope, IncomingFrames, LogicalConnection.Listener, Connection.Listener
{
    private static final Callback EMPTY = Callback.NOOP;
    ...
    public WebSocketSession(WebSocketContainerScope containerScope, URI requestURI, EndpointFunctions endpointFunctions, Object endpoint, LogicalConnection connection, RemoteEndpoint remoteEndpoint)
    {
        ...
        this.endpointFunctions = endpointFunctions;
    ...
    public String toString()
    {
        ...
        {
            LogicalConnection connection = getConnection();
            sb.append(',').append(connection.getClass().getSimpleName());
            if(connection.isOpen())
            {
                sb.append(',').append(connection.toString());
                // TODO: move to connection classes
