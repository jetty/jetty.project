...
public class CloseInfoTest
{
    ...
    public void testAnonymousClose()
    {
        ...
        assertThat("close.code",close.getStatusCode(), Matchers.is(StatusCode.NO_CODE));
    ...
    public void testNoClose()
    {
        ...
        assertThat("close.code",close.getStatusCode(), Matchers.is(StatusCode.NO_CLOSE));
        assertThat("close.reason",close.getReason(),nullValue());
    ...
    public void testFailedTlsHandshake()
    {
        ...
        assertThat("close.code",close.getStatusCode(), Matchers.is(StatusCode.FAILED_TLS_HANDSHAKE));
        assertThat("close.reason",close.getReason(),nullValue());
    ...
    public void testNormal()
    {
        ...
        assertThat("close.code",close.getStatusCode(), Matchers.is(StatusCode.NORMAL));
        assertThat("close.reason",close.getReason(),nullValue());
