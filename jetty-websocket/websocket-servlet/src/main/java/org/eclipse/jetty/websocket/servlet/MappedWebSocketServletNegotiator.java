...
/**
 * {@link PathSpec} to {@link WebSocketServletNegotiator} interface
 */
public interface MappedWebSocketServletNegotiator
{
    /**
    ...
    /**
     * Add a WebSocket mapping to a provided {@link WebSocketServletNegotiator}.
     * <p>
     ...
     * @since 10.0
     */
    void addMapping(PathSpec pathSpec, WebSocketServletNegotiator negotiator);
     ...
     */
    WebSocketServletNegotiator getMapping(PathSpec pathSpec);
     ...
     */
    MappedResource<WebSocketServletNegotiator> getMatch(String target);
}