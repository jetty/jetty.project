...
public class JettyPolicyTest
{
    ...
    /**
     * Simple test for loading a policy file and validating that the AllPermission was granted successfully.
     */
    @Test
    public void testGlobalAllPermissionLoader() throws Exception
    {

        JettyPolicy ap = new JettyPolicy(Collections.singleton(MavenTestingUtils.getBasedir().getAbsolutePath()
                + "/src/test/resources/global-all-permission.policy"),evaluator);
        ap.refresh();
    ...
    /**
     * Simple test of loading a policy file with a single codebase defined that grants specific FilePermission. Then test that read and write were granted but
     * delete was not.
     */
    @Test
    ...
    /**
     * Tests multiple codebases in a single policy file are loaded correctly and that the various grants do indeed work accordingly
     * 
     * @throws Exception
     */
    @Test
    ...
    {
        JettyPolicy ap = new JettyPolicy(Collections.singleton(MavenTestingUtils.getBasedir().getAbsolutePath() + "/src/main/config/lib/policy/jetty.policy"),
                evaluator);
    ...
    /**
     * Tests the aggregation of multiple policy files into the same protection domain of a granted codesource
     * 
     * @throws Exception
     */
    @Test
    ...
    public void testTemplateDirectories() throws Exception
    {
        ...
        templateFiles.add(MavenTestingUtils.getBasedir().getAbsolutePath() + "/src/test/resources/template");
