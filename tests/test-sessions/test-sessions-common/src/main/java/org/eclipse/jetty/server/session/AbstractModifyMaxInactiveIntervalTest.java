...
public abstract class AbstractModifyMaxInactiveIntervalTest extends AbstractTestBase
{
    ...
    public void testSessionExpiryAfterModifiedMaxInactiveInterval() throws Exception
    {
        ...
        ((AbstractSessionDataStoreFactory)storeFactory).setGracePeriodSec(__scavenge);
        
        TestServer server = new TestServer (0,__inactive,__scavenge, cacheFactory, storeFactory);
    ...
    public static class TestModServlet extends HttpServlet
    {
        ...
        protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
        {
            ...
            if ("test".equals(action))
            {
                ...
                assertEquals(AbstractModifyMaxInactiveIntervalTest.newMaxInactive, session.getMaxInactiveInterval());
                return;
            }
        }
    }
